  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full px-4 py-3 rounded-xl bg-gray-950 border border-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500/50 transition-all-200"
      >
        ...
        <div className="expand-enter mt-2 p-3 rounded-xl bg-gray-950/80 border border-teal-500/20">
          ...
          <div className="space-y-2">
            <input type="text" required value={name} onChange={e => setName(e.target.value)}
              ...
              className="w-full px-3 py-2 rounded-lg bg-gray-900 border border-gray-700 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-teal-500/50 transition-all-200"
            ...
            <button type="button" onClick={handleSubmit} disabled={saving || !name.trim()}
              className="w-full py-2 rounded-lg bg-teal-500 hover:bg-teal-600 disabled:opacity-50 text-gray-950 text-xs font-bold transition-all-200 flex items-center justify-center gap-1">
