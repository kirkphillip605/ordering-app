...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'products.categoryPlaceholder': 'e.g. Beverage, Food...',
    'products.isFrequentlyOrdered': 'Frequently Ordered',
    ...
    'products.linkedVendors': 'Linked Vendors',
  ...
  zh: {
    ...
    'products.categoryPlaceholder': '例如：饮料、食品...',
    'products.isFrequentlyOrdered': '常点商品',
    'products.variants': '变体',
    'products.addVariant': '添加变体',
    'products.variantName': '变体名称',
    'products.selectVariant': '选择变体',
    'products.details': '产品详情',
    'products.linkedVendors': '关联供应商',
    'products.allCategories': '所有类别',
    'products.allBrands': '所有品牌',
